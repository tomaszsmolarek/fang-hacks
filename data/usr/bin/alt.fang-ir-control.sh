...
do
        ...
        then
                ...
                then
                        ...
                        # Sometimes if there's night mode on and it gets darker and darkes very slowly, the camera won't adjust and will end up showing a very dark (almost black) image
